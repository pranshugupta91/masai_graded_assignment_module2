...
-- total number of orders placed, and total amount spent. Include only
...
-- Business Question:
-- "For each product category, show the category name, number of different
-- products sold, total quantity sold, and total revenue generated. Only
-- include categories that have generated more than ₹10,000 in revenue.
...
-- Business Question:
-- "Show monthly sales trends for the year 2024. For each month, display
-- the month name, total number of orders, total revenue, and the running
